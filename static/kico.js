...
(function (global, setting) {
    ...
    console.log("%c Kico Style %c https://github.com/yiwan95","color: #fff; margin: 1em 0; padding: 5px 0; background: #3498db;","margin: 1em 0; padding: 5px 0; background: #efefef;");
})(window);